...
const Sidebar = ({ show, adminLoading }) => {
    const { isAdmin, setSelectedService, setSelectedPackage } = useContext(UserContext);
                ...
                <ul className="list-unstyled components">
                    ...
                    {isAdmin ?
                        <>
                            ...
                            <li>
                                <Link to="/dashboard/paymentList" className={panel === "paymentList" ? "link-active" : ""}>
                                    <FontAwesomeIcon icon={faMoneyCheck} /> <span>Payment List</span>
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/dashboard/addPackage" className={panel === "addPackage" ? "link-active" : ""}>
                                    <FontAwesomeIcon icon={faFileMedical} /> <span>Add Package</span>
                                    {/* <AddPackage/> */}
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/dashboard/managePackage" className={panel === "managePackage" ? "link-active" : ""}>
                                    <FontAwesomeIcon icon={faCog} /> <span>Manage Package</span>
                                </Link>
                            </li>
                        </>
                        : <>
                            ...
                            <li>
                                <Link to="/dashboard/payment" className={panel === "payment" ? "link-active" : ""}>
                                    <FontAwesomeIcon icon={faMoneyCheck} /> <span>Payment</span>
                                </Link>
                            </li>
                        </>}
                </ul>}
            <ul style={{marginTop:"-30px"}} className="list-unstyled CTAs ">
                <li onClick={reset} >

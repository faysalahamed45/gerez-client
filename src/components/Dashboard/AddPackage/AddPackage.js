...
const AddPackage = ({ editService, restrictPermission, setEditService }) => {
  // console.log(editService);
  // editService ? console.log("editService.Packagetitle") : console.log("object");;
    ...
    const onSubmit = async data => {
        ...
        if (editService) {
            ...
            axios.patch(`https://pure-atoll-66880.herokuapp.com/update/package/${editService._id}`, serviceInfo)
                .then(res => {
                    toast.dismiss(loading);
                    if (res.data) {
        ...
        axios.post('https://pure-atoll-66880.herokuapp.com/addPackage', serviceInfo)
            .then(res => {
                toast.dismiss(loading);
                if (res.data) {
                ...
                <div className="py-5 mx-auto mt-5 bg-white form-main" style={{ borderRadius: "15px", maxWidth: '85rem' }}>
                    <Form.Row className="justify-content-center">
                        <Form.Group as={Col} md={5} sm={12} className="mr-md-5">
                            ...
                            <Form.Control
                                type="text"
                                defaultValue={editService ? editService.Packagetitle : ""}
                        ...
                        <Form.Group as={Col} md={5} sm={12}>
                            ...
                            <Form.Control
                                ...
                                type="text"
                                defaultValue={ editService? editService.Packageprice : ""}
                        ...
                        <Form.Group as={Col} md={5} sm={12} className="mr-md-5 mt-md-3">
                            ...
                            <Form.Control
                                style={{ height: "10rem" }}
                                type="text"
                                defaultValue={ editService? editService.Packagedescription : ""}
                                as="textarea"

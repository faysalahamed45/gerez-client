...
const OrderList = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://pure-atoll-66880.herokuapp.com/orders?email=${email}`)
      .then((res) => {
        setOrders(res.data);
        setLoading(false);
      })
  ...
  const handleStatusChange = (id, status) => {
    ...
    axios
      .patch("https://pure-atoll-66880.herokuapp.com/updateOrderStatus", modifiedStatus)
